...
pub const BOARD_SIZE: usize = 10;       // defining the size of the game board

pub struct Board{                       // structuring the board
    grid: [[CellState; BOARD_SIZE]; BOARD_SIZE],
    ships: Vec<(usize, usize)>,
}

#[derive(Clone, Copy, PartialEq)]
pub enum CellState {                    // different types of states
    Empty,
    Ship,
    Hit,
    Miss,
...
impl Board {
    pub fn new() -> Self{               // constructor where we set the board
        Board{
